...
internal static class PokerOddsCalculator
{
    ...
    public static OddsResult Calcular(string cartasJugadorTexto, string cartasMesaTexto, int rivales)
    {
        ...
        return new OddsResult(
            ...
            total == 0 ? 0 : (double)perdidas / total,
...
internal sealed record OddsResult(double ProbabilidadGanar, double ProbabilidadPerder, double ProbabilidadEmpatar, string DescripcionMano);
